...
if (.52 != GM_info.script.version) throw alert("У вас установлена устаревшая версия скрипта!\n\nYou have an outdated version of the script installed!"), window.open("https://raw.githubusercontent.com/T0HBA/TOHBA/main/TOHBA.user.js", "_blank").focus(), new Error("stop");
class Utils {
    getRootElement = null;
    getRootObject = null;
...
const s = atob("SGlfSGlfQ3ljSW9uZQ==");
...
!async function() {
    ...
    ImGui.GetStyle().WindowPadding = new ImGui.ImVec2(5, 5), ImGui.GetStyle().FramePadding = new ImGui.ImVec2(5, 5), ImGui.GetStyle().ItemSpacing = new ImGui.ImVec2(5, 5), ImGui.GetStyle().ItemInnerSpacing = new ImGui.ImVec2(2, 2), ImGui.GetStyle().TouchExtraPadding = new ImGui.ImVec2(0, 0), ImGui.GetStyle().IndentSpacing = 0, ImGui.GetStyle().ScrollbarSize = 10, ImGui.GetStyle().GrabMinSize = 10, ImGui.GetStyle().WindowBorderSize = 1, ImGui.GetStyle().ChildBorderSize = 1, ImGui.GetStyle().PopupBorderSize = 1, ImGui.GetStyle().FrameBorderSize = 1, ImGui.GetStyle().TabBorderSize = 1, ImGui.GetStyle().WindowRounding = 5, ImGui.GetStyle().ChildRounding = 5, ImGui.GetStyle().FrameRounding = 5, ImGui.GetStyle().PopupRounding = 5, ImGui.GetStyle().ScrollbarRounding = 5, ImGui.GetStyle().GrabRounding = 5, ImGui.GetStyle().TabRounding = 5, ImGui.GetStyle().WindowTitleAlign.x = .5, ImGui.GetStyle().WindowTitleAlign.y = .5, ImGui.GetStyle().ButtonTextAlign.x = .5, ImGui.GetStyle().ButtonTextAlign.y = .5, ImGui.GetStyle().SelectableTextAlign.x = .5, ImGui.GetStyle().SelectableTextAlign.y = .5, ImGui.GetStyle().WindowPadding.x = 5, ImGui.GetStyle().WindowPadding.y = 5, ImGui.GetStyle().FramePadding.x = 5, ImGui.GetStyle().FramePadding.y = 5, ImGui.GetStyle().ItemSpacing.x = 5, ImGui.GetStyle().ItemSpacing.y = 5, ImGui.GetStyle().ItemSpacing.x = 2, ImGui.GetStyle().ItemSpacing.y = 2, ImGui.GetStyle().TouchExtraPadding.x = 0, ImGui.GetStyle().TouchExtraPadding.y = 0, e[ImGui.Col.Text] = new ImGui.Vec4(255, 255, 255), e[ImGui.Col.TextDisabled] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.WindowBg] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.ChildBg] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.PopupBg] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.Border] = new ImGui.Vec4(255, 255, 255), e[ImGui.Col.BorderShadow] = new ImGui.Vec4(255, 255, 255), e[ImGui.Col.FrameBg] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.FrameBgHovered] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.FrameBgActive] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.TitleBg] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.TitleBgActive] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.TitleBgCollapsed] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.MenuBarBg] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.ScrollbarBg] = new ImGui.Vec4(255, 255, 255), e[ImGui.Col.ScrollbarGrab] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.ScrollbarGrabHovered] = new ImGui.Vec4(0, 0, 0), e[ImGui.Col.ScrollbarGrabActive] = new ImGui.Vec4(0, 0, 204), e[ImGui.Col.CheckMark] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.SliderGrab] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.SliderGrabActive] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.Button] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.ButtonHovered] = new ImGui.Vec4(0, 0, 0), e[ImGui.Col.ButtonActive] = new ImGui.Vec4(0, 0, 255), e[ImGui.Col.Header] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.HeaderHovered] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.HeaderActive] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.Separator] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.SeparatorHovered] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.SeparatorActive] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.ResizeGrip] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.ResizeGripHovered] = new ImGui.Vec4(0, 0, 0), e[ImGui.Col.ResizeGripActive] = new ImGui.Vec4(0, 0, 255), e[ImGui.Col.Tab] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.TabHovered] = new ImGui.Vec4(0, 0, 0), e[ImGui.Col.TabActive] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.TabUnfocused] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.TabUnfocusedActive] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.PlotLines] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.PlotLinesHovered] = new ImGui.Vec4(0, 255, 0, 0), e[ImGui.Col.PlotHistogram] = new ImGui.Vec4(255, 0, 0), e[ImGui.Col.PlotHistogramHovered] = new ImGui.Vec4(1, .6, 0, 1), e[ImGui.Col.TextSelectedBg] = new ImGui.Vec4(1, 0, 0, .35), e[ImGui.Col.DragDropTarget] = new ImGui.Vec4(1, 1, 0, .9), e[ImGui.Col.NavHighlight] = new ImGui.Vec4(.26, .59, .98, 1), e[ImGui.Col.NavWindowingHighlight] = new ImGui.Vec4(1, 1, 1, .7), e[ImGui.Col.NavWindowingDimBg] = new ImGui.Vec4(.8, .8, .8, .2), e[ImGui.Col.ModalWindowDimBg] = new ImGui.Vec4(0, 0, 0, .7)
...
Utils.getStates(), setInterval(Utils.saveStates, 5e3), requestAnimationFrame(mainEvent), console.clear(), alert("Do not use this hack on real game If you use this hack on real game your account will be permanently banned. \n\nНе используйте этот хак в реальной игре. Если вы используете этот хак в реальной игре, ваша учетная запись будет заблокирована навсегда.");